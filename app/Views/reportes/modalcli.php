                    ...
                    <table id="tabla_m_cliente" class="table table-striped table-hover" style="width: 100% !important;">
                        ...
                        <?php foreach ($datos as $dato) { ?>
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-success btn-sm" onclick="seleccionar_cliente('id_cliente,nombrecli/A,2-3'+'/-/#/#',['<?= $dato['id']; ?>','<?= $dato['nombre']; ?>','<?= $dato['nomcom']; ?>'])"><i class="fa-solid fa-check me-2"></i>Aceptar</button>
                                </td>
                            </tr>
                        <?php }; ?>
                        </tbody>
