<div class="container">
    ...
    <div class="row mt-2 justify-content-center">
        <div class="col-auto text-center pe-5 ps-5 border-bottom border-primary">
            <h4 class="text-primary">Editar servicio</h4>
        </div>
    </div>
    <!-- INPUT PARA REGISTRO -->
            ...
            <div class="col-12">
                <div class="input-group mb-3">
                    ...
                    <div class="form-floating">
                        <input type="text" class="form-control text-primary" id="nombre" placeholder="Nombre" name="nombre" value="<?= $data[0]['nombre']; ?>">
                        <input type="text" id="id" name="id" hidden value="<?= $data[0]['id']; ?>">
        ...
        <div class="row">
            <div class="col-12">
                <div class="input-group mb-3">
                    <span class="input-group-text bg-dark bg-gradient text-white"><i class="fa-regular fa-user"></i></span>
                    <div class="form-floating">
                        <input type="text" class="form-control text-primary" id="descripcion" placeholder="Descripción" name="descripcion" value="<?= $data[0]['descripcion']; ?>">
